...
This guide will help you deploy Agent0 to Fly.io.
...
# If using real OpenDental API:
fly secrets set OPENDENTAL_MOCK_MODE="false"
fly secrets set OPENDENTAL_API_BASE_URL="https://api.opendental.com/api/v1"
fly secrets set OPENDENTAL_API_KEY="ODFHIR NFF6i0KrXrxDkZHt/VzkmZEaUWOjnQX2z"

# OR if using mock mode:
fly secrets set OPENDENTAL_MOCK_MODE="true"
```
