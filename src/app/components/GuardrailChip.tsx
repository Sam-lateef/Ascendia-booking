...
export function GuardrailChip({
  ...
  // Variables for icon, label, and styling based on state
  let IconComponent;
  let label: string;
        ...
        >
          <div className="pt-2 text-xs">
            ...
            {guardrailResult.testText && (
              <blockquote className="mt-1 border-l-2 pl-2" style={{ borderColor: 'var(--border-gray)', color: 'var(--text-gray-dim)', opacity: 0.7 }}>
                {guardrailResult.testText}
              </blockquote>
            )}
          </div>
